...
export const name = 'Shoaib Khalil';
export const avatar = me;
export const about = () => {
  return (
    <>
      Hey, I'm a Full Stack Engineer who loves solving problems through programming. I work at FortressGB as a Software Engineer.
    </>
  );
};
export const bio = () => {
  return (
    <>
      When I'm not coding, I'm probably playing badminton or learning a new skill. I love to travel and explore new places & culture.
    </>
  );
};
`;
...
const about = `export default function AboutPage() {
  return (
    <section>
      ...
      <p>
        HTML, CSS, Javascript, Bootstrap, Angular, React, C#,
        .NET Core, Web API's, Git, SQL.
      </p>
    </section>
  );
}
